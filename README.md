...
> **R:**Porque programa.i es el archivo de preprocesamiento con sus include y macros, que en programa.c no aparecen de forma explicita.
...
> **R:**indican el archivo original y la linea de donde proviene el codigo luego del preprocesamiento. La declaracion print viene de stdio.h .
...
> **R:**esta preparando la funcion para poder utilizar la pila y tambien debuggear.
...
> **R:**porque en programa.o la funcion esta usada pero no definida.
...
> **R:**Pertenecen a librerias externas y se resuelven en tiempo de ejecucion.
...
> **R:**una macro funcion no funciona como una tipica, esta busca y reemplaza, por eso desaparece en el preprocesamiento.
> En cambio la funcion sumar es real y se compila y llama durante ejecucion, devolviendo un resultado, esta ultima si tiene verificacion de tipos.  
...
> **R:**T corresponde a codigo y esta en .txt , D corresponde a datos globales y esta en .data .
